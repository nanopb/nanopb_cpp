...
* `Int32CallbackConverter`
* `SInt32CallbackConverter`
* `UInt32CallbackConverter`
* `Fixed32CallbackConverter`
* `SFixed32CallbackConverter`
* `FloatCallbackConverter`
* `BoolCallbackConverter`
* `StringCallbackConverter`
* `BytesCallbackConverter`

**64 bit scalar types, supported only if definition `PB_WITHOUT_64BIT` was not set:**

* `Int64CallbackConverter`
* `SInt64CallbackConverter`
* `UInt64CallbackConverter`
* `Fixed64CallbackConverter`
* `SFixed64CallbackConverter`
* `DoubleCallbackConverter`

### Container converters:

All container converters are derived from `CallbackConverter` class.

* `ArrayCallbackConverter` - Array converter for `std::vector<xxx>` or `std::list<xxx>`.
* `ArrayMessageCallbackConverter` - Repeated convertor for `std::vector<CLASS>` or `std::list<CLASS>`. 
