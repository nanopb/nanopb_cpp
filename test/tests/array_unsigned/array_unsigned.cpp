...
public:
    static ProtoType encoderInit(const LocalType& local) {
        return ProtoType{
                .values = ArrayUnsignedCallbackConverter<typename LocalType::ContainerType>::encoderCallbackInit(local.values)
        };
    }

    static ProtoType decoderInit(LocalType& local){
        return ProtoType{
                .values = ArrayUnsignedCallbackConverter<typename LocalType::ContainerType>::decoderCallbackInit(local.values)
        };
    }
