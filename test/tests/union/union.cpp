...
class InnerMessageOneConverter : public SingleArgMessageConverter<
...
class InnerMessageTwoConverter : public SingleArgMessageConverter<
...
class InnerMessageThreeConverter : public SingleArgMessageConverter<
